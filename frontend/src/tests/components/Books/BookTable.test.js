...
describe("BookTable tests", () => {
  ...
  test("Has the expected column headers, content and buttons", () => {
    ...
    expect(screen.getByTestId(`${testId}-cell-row-0-col-title`)).toHaveTextContent("To Kill a Mockingbird");

    expect(screen.getByTestId(`${testId}-cell-row-1-col-id`)).toHaveTextContent("3");
    expect(screen.getByTestId(`${testId}-cell-row-1-col-title`)).toHaveTextContent("The Catcher in the Rye");
  ...
  test("Edit button navigates to the edit page", async () => {
    ...
    const expectedMessage = `editCallback: {"id":2,"title":"To Kill a Mockingbird","author":"Harper Lee"})`;
